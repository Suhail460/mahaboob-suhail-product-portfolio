...
export function HeroCanvasScroll() {
  ...
  // Track scroll from top of Hero (0) until Hero leaves viewport (1)
  ...
  const mahaboobX = useTransform(scrollYProgress, [0, 0.7], ["0%", "-70%"])
  const suhailX = useTransform(scrollYProgress, [0, 0.7], ["0%", "70%"])
  ...
  // Handle frame drawing on scroll progress change (Smooth 100-frame progression as user scrolls past Hero)
  ...
  return (
    <div ref={containerRef} className="relative min-h-screen h-screen w-full overflow-hidden bg-[#09090b]">
