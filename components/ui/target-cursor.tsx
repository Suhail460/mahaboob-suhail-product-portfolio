...
export const TargetCursor: React.FC<TargetCursorProps> = ({
  ...
  return createPortal(
    ...
    >
      ...
      />
      <div
        className="target-cursor-corner absolute top-1/2 left-1/2 w-3.5 h-3.5 border-[3px] -translate-x-[150%] -translate-y-[150%] border-r-0 border-b-0 rounded-tl-sm"
        style={{ willChange: "transform", borderColor: cursorColor }}
      />
      <div
        className="target-cursor-corner absolute top-1/2 left-1/2 w-3.5 h-3.5 border-[3px] translate-x-1/2 -translate-y-[150%] border-l-0 border-b-0 rounded-tr-sm"
        style={{ willChange: "transform", borderColor: cursorColor }}
      />
      <div
        className="target-cursor-corner absolute top-1/2 left-1/2 w-3.5 h-3.5 border-[3px] translate-x-1/2 translate-y-1/2 border-l-0 border-t-0 rounded-br-sm"
        style={{ willChange: "transform", borderColor: cursorColor }}
      />
      <div
        className="target-cursor-corner absolute top-1/2 left-1/2 w-3.5 h-3.5 border-[3px] -translate-x-[150%] translate-y-1/2 border-r-0 border-t-0 rounded-bl-sm"
        style={{ willChange: "transform", borderColor: cursorColor }}
      />
    </div>,
    document.body
