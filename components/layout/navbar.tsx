...
export function Navbar() {
  ...
  const scrolledPast = scrollY > 40

  return (
    <>
      <header
        className="fixed top-0 left-0 right-0 z-40 transition-all duration-300 px-4 md:px-12 py-3.5"
        style={{
          background: scrolledPast ? "rgba(9, 9, 11, 0.88)" : "transparent",
        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <Link href="/" className="group flex items-center gap-2.5">
            ...
            <span className="font-mono-tag text-xs md:text-sm font-bold uppercase tracking-wider text-white">
              SUHAIL <span className="text-[#a1a1aa] font-normal">// PORTFOLIO</span>
            </span>
          </Link>

          {/* Quick Nav Anchors for Desktop */}
          <nav className="hidden lg:flex items-center gap-8 font-mono-tag text-xs uppercase text-neutral-400">
          ...
          <div className="flex items-center gap-3">
            <a
              ...
              className="hidden sm:flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white/5 border border-white/10 hover:border-[#b39ddb] hover:text-[#b39ddb] text-xs font-mono-tag uppercase transition-all"
            >
              <FaLinkedin size={13} />
              <span>LinkedIn</span>
            </a>
            ...
            <a
              ...
              target="_blank"
              download
              className="hidden sm:flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white/10 border border-white/20 hover:bg-[#e58e39] hover:text-[#09090b] hover:border-[#e58e39] text-xs font-mono-tag uppercase font-bold transition-all"
            >
            ...
            <button
              ...
              className="flex items-center gap-3 px-4 py-2 rounded-full bg-white/10 border border-white/20 hover:border-[#e58e39] hover:bg-white/15 transition-all text-xs font-mono-tag uppercase font-bold text-white cursor-pointer group"
            >
              <span>Menu</span>
