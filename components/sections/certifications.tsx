...
export function CertificationsSection() {
  return (
    <section className="py-28 md:py-36 relative border-t border-white/10 studio-grid-bg">
      <div className="max-w-7xl mx-auto px-4 md:px-12">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-16">
          <div>
            <div className="flex items-center gap-3 mb-4">
              ...
              <p className="font-mono-tag text-xs md:text-sm font-bold uppercase tracking-[0.2em] text-[#f4a261]">
        ...
        {/* Double-Bezel Certifications Grid */}
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {certifications.map((cert, i) => (
            <motion.a
              ...
              className="group rounded-2xl bg-white/5 border border-white/10 p-1.5 hover:border-[#f4a261]/40 transition-all flex flex-col justify-between"
            >
